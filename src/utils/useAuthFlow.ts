...
const SSO_ENDPOINT =
  "https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=f801c87d-d572-4b64-8aa7-5dcd20e0af7b&response_type=code&redirect_uri=http://localhost:3000/login&scope=openid";
